...
class GLFWwindow : public QWindow, protected QOpenGLFunctions
{
   Q_OBJECT
...
public:
	...
	GLFWkeyfun keycb;
	GLFWcharfun charevent;
	GLFWcursorposfun cursorpos;
	GLFWmousebuttonfun mousebutton;    
	GLFWscrollfun scrollevent;
...
void glfwSetErrorCallback(GLFWerrorfun errorcb) { }
void glfwWindowHint(int hint, int val) { }
bool glfwInit() { return GLFW_OK; }
...
void glfwPollEvents() { qApp->processEvents(); }
void glfwTerminate() { qApp->exit(); }
...
int main()
{
	...
	_vg = nvgCreateGL2(NVG_ANTIALIAS);
	if (_vg == NULL) {
